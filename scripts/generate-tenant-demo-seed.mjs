...
const users = [
  { id: 'member_admin', email: 'admindemo@tnc.io.vn', full_name: 'Giám Đốc (CEO)', role: 'admin', status: 'active' },
  { id: 'member_manager', email: 'quanlydemo@tnc.io.vn', full_name: 'Quản Lý Điều Hành', role: 'manager', status: 'active' },
  { id: 'member_accountant', email: 'ketoandemo@tnc.io.vn', full_name: 'Kế Toán Trưởng', role: 'accountant', status: 'active' },
  { id: 'member_driver', email: 'taixedemo@tnc.io.vn', full_name: 'Tài Xế Demo (TX0001)', role: 'driver', status: 'active' },
  { id: 'member_dispatcher', email: 'dispatcher@tnc.io.vn', full_name: 'Điều Phối Viên', role: 'dispatcher', status: 'active' },
  { id: 'member_viewer', email: 'viewer@tnc.io.vn', full_name: 'Khách Xem', role: 'viewer', status: 'active' },
];
